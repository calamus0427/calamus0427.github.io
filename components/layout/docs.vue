  ...
  <div>
      ...
      <a-timeline mode="alternate">
        ...
        <a-timeline-item>
          <a-icon slot="dot" type="crown" style="font-size: 16px;color: #6b4b47" />
          <div>
            <a  href="http://calamus0427.github.io/docs/uni-app/introduce/#/" target="_blank" class="title">uni-app入门与实践</a>
            <p class="content">跨端统一框架 💯 uni-app学习笔记 🙌</p>
            <p class="img_des"><img src="https://cdn.calamus.xyz/uni/index.jpeg" alt=""></p>
          </div>
        </a-timeline-item>
        <a-timeline-item>
